$(function(){
  ...
  //$('body').on('click', '#add_item_edit', chkItem);
  ...
  //     var splitId   = trgtTabId.split("tab"); //商品ID(no_underscore_id)を取得
  ...
  //                 '<input id="item_name_'+ts+'" type="text" class="form-control" name="item_name[]">'
  //               );
  //       //outside_condition
  //       $("#item_request_table_"+ts+">tbody").append(
  ...
  //         '<button type="button" id="delete_btn'+ts+'" class="btn btn-danger">削除</button>'
  //       );
  // }
